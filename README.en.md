...
| What | Link |
|------|------|
| 📦 Download the trial build | [Releases](https://github.com/estherdata2026/esther-official-resources/releases) |
...
| 🐛 Report a bug | [Issues](https://github.com/estherdata2026/esther-official-resources/issues) (please use an issue template) |
| 💡 Feature requests | [Issues](https://github.com/estherdata2026/esther-official-resources/issues) |
...
- When the trial expires, run `esther-cli.exe license fingerprint` and send us the fingerprint to obtain a license file (`esther.lic`).
...
- For bugs, please open an [issue](https://github.com/estherdata2026/esther-official-resources/issues) and include the **SQL text, dialect, expected vs. actual result** as prompted by the template.
- For licensing inquiries, please leave a message via an issue or contact the publisher.
